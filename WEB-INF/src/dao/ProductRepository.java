...
public class ProductRepository {
	...
	public ProductRepository() {
        Product book1 = new Product("b9791130692258", "하쿠다 사진관", 15500);
        book1.setDescription("지친 인생들의 마음 치유소");
        book1.setCategory("장편소설");
        book1.setManufacturer("놀");
        book1.setUnitsInStock(1000);
        book1.setCondition("Old");
        book1.setFilename("b9791130692258.jpg");
        
        Product book2 = new Product("b9788954699914", "하얼빈", 16000);
        ...
        book2.setFilename("b9788954699914.jpg");
        
        Product book3 = new Product("b9788959897094", "트렌드코리아2023", 19000);
        ...
        book3.setFilename("b9788959897094.jpg");
        
        Product book4 = new Product("b9791156643388", "쉽게 배우는 JSP 프로그래밍", 27000);
        ...
        book4.setFilename("b9791156643388.jpg");
        
        Product book5 = new Product("b9791191891201", "잘될 수 밖에 없는 너에게", 16000);
        ...
        book5.setFilename("b9791191891201.jpg");
        
        Product book6 = new Product("b9788936438838", "아버지의 해방일지", 15000);
        ...
        book6.setFilename("b9788936438838.jpg");
        
        Product book7 = new Product("b9791161692234", "수상한 초콜릿 가게", 13500);
        ...
        book7.setFilename("b9791161692234");
        
        Product book8 = new Product("b9791186116357", "통찰의 시간", 18000);
        ...
        book8.setFilename("b9791186116357");
        
    	Product book9 = new Product("b9791191769203", "빠르게 실패하기", 16500);
        ...
        book9.setFilename("b9791191769203.jpg");
